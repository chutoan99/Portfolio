...
// From containers/footer/index.tsx. react-i18next useTranslation -> $t in template.
// SVG attrs converted to kebab-case (fillRule -> fill-rule, clipRule -> clip-rule).
</script>

<template>
	<footer
		class="
			bg-primary-tint/[0.05] flex justify-center h-full
		...
		<div
			...
			<ul class="flex gap-[15px] justify-start items-center list-none md:justify-end">
				<!-- facebook -->
				<li
					class="w-[24px] h-[24px] shrink-0 hover:opacity-70 transition duration-500 cursor-pointer">
