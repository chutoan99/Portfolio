...
// From containers/background/index.tsx.
// - Framer <motion.canvas animate={{opacity:0.6}}> -> v-motion :enter (durations in ms).
// - The imperative canvas particle system stays; useEffect -> onMounted, with the
//   requestAnimationFrame loop and resize listener cleaned up on unmount.
...
const IMAGE_SOURCES = [
	...
	'https://res.cloudinary.com/dxcershra/image/upload/v1691073502/porfolio/Group_17_ankllr.png',
	...
	'https://res.cloudinary.com/dxcershra/image/upload/v1708862232/porfolio/hjanozt41vvzsjsxioc8.png',
	...
	'https://res.cloudinary.com/dxcershra/image/upload/v1708862232/porfolio/njzuegh912cz2btx5h0a.png',
	...
	'https://res.cloudinary.com/dxcershra/image/upload/v1708862231/porfolio/oaywnehic6uqxavt0lnk.png',
...
<template>
	<div
		class="bg-surface z-0 relative h-[100vh] flex justify-center items-center flex-col gap-[20px">
		<canvas
			ref="canvasRef"
			v-motion
			class="absolute inset-0 w-full h-full"
			:initial="{ opacity: 0 }"
			:enter="{ opacity: 0.6, transition: { duration: 400, delay: 1400 } }" />
	</div>
</template>
