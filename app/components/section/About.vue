...
// From containers/about/index.tsx (+ inlined AvatarCard as <AvatarCard/>).
// react-i18next -> $t; SVG presentation attrs converted to kebab-case.
// NOTE: the "Download My Resume" anchor had no href in the original (download only),
// so it is preserved as-is to keep behaviour identical.
</script>

<template>
	<section id="about" class="bg-surface px-0 py-[50px] lt:py-[100px]">
		<div
			data-aos="fade-right"
			data-aos-offset="200"
			...
			<div
				...
				<div
					...
					<div
						...
						<div
							class="flex justify-start items-center w-full h-[32px] gap-[28px] lt:justify-start lt:order-1">
							<span class="w-[60px] h-[2px] bg-primary" />
							<div class="flex items-center gap-[25.5px]">
								<a
									href="#" aria-label="Social profile"
									class="group hover:cursor-pointer hover:transition-all hover:duration-500 hover:ease-[cubic-bezier(0.4,0,0.2,1)]">
									<svg width="20" height="23" viewBox="0 0 20 23" fill="none">
										<g clip-path="url(#clip0_290_102)">
											<path
												...
												fill="#7d11f9"
												class="group-hover:fill-primary-hover transition-colors duration-300" />
										</g>
										<defs>
											<clipPath id="clip0_290_102">
												<rect
													...
													height="22"
													fill="white"
													transform="matrix(1 0 0 -1 0.650024 22.59)" />
											</clipPath>
										</defs>
									</svg>
								</a>
										...
										<defs>
											<clipPath id="clip0_290_104">
												<rect
													...
													height="22"
													fill="white"
													transform="matrix(1 0 0 -1 0.459961 22.59)" />
											</clipPath>
										</defs>
									</svg>
								</a>
								<a
									href="https://www.facebook.com/profile.php?id=100068599721013" aria-label="Facebook profile"
									class="group hover:cursor-pointer hover:transition-all hover:duration-500 hover:ease-[cubic-bezier(0.4,0,0.2,1)]">
									<svg width="13" height="23" viewBox="0 0 13 23" fill="none">
										<g clip-path="url(#clip0_290_106)">
											<path
										...
										<defs>
											<clipPath id="clip0_290_106">
												<rect
													...
													height="22"
													fill="white"
													transform="matrix(1 0 0 -1 0.420044 22.59)" />
											</clipPath>
										</defs>
									</svg>
								</a>
										...
										<defs>
											<clipPath id="clip0_290_108">
												<rect
													...
													height="22"
													fill="white"
													transform="matrix(1 0 0 -1 0.0900879 22.59)" />
											</clipPath>
										</defs>
									</svg>
								</a>
