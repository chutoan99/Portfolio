export default function FormInfo() {
	return (
		<div
			...
			className='
                w-full flex flex-col items-start gap-[15px] 
                sm:gap-[15px] sm:p-[15px]
                md:gap-[20px] md:w-[45%]  
                lg:w-[495px]
            '>
			{/* phone */}
			<div className='h-full sm:h-[55px] w-[495px]'>
				<div
					className='
                        flex gap-[24px] 
					...
					<div
						className='
                            flex items-center gap-[24px] w-[495px] 
                            sm:w-full sm:gap-[16px]
                        '>
						<div
							className='
