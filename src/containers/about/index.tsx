...
export default function About() {
  return (
    <section
      ...
      "
    >
      <div data-aos="fade-right" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="500" className="max-w-[75rem] mx-auto">
        <div
          className="
        ...
        >
          <AvatarCard />
          <div data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="800" className="w-full h-full lt:w-[50rem] lt:h-[30.5525rem]">
            <span className="flex flex-col justify-center text-[#8c89a2] font-semibold text-[1.125rem] uppercase leading-[2.25rem] tracking-[0.0625rem] h-[1.625rem] lt:h-[6.26563rem]">About Me</span>
            <h3 className="flex flex-col justify-center shrink-0 text-[2rem] leading-[3rem] text-[#3f3a64] font-normal w-full mt-[0.5rem] lt:w-[23.4375rem] lt:text-[2.5rem]">Truong Van Chu Toan</h3>
              ...
              <div className="grid mt-[0.313rem] lt:grid-cols-2">
                <div className="inline-flex pt-0 items-start h-[1.8rem] pb-[0.05rem] gap-[0.905rem] shrink-0">
                  <div className="h-[1.75rem] flex flex-col justify-center text-[1.2rem] not-italic">
                    <label className="font-semibold leading-[1.8rem] text-[#3f3a64]">Name:</label>
                  </div>
                  <div className="h-[1.75rem] flex flex-col justify-center text-[1.2rem] not-italic">
                    <span className="font-normal text-[#696969]">Truong Van Chu Toan</span>
                  </div>
                </div>
                <div className="inline-flex pt-0 items-start h-[1.8rem] pb-[0.05rem] gap-[0.905rem] shrink-0">
                  <div className="h-[1.75rem] flex flex-col justify-center text-[1.2rem] not-italic">
                    <label className="font-semibold leading-[1.8rem] text-[#3f3a64]">Age:</label>
                  </div>
                  <div className="h-[1.75rem] flex flex-col justify-center text-[1.2rem] not-italic">
                    <span className="font-normal text-[#696969]">24 Years</span>
                  </div>
                </div>
              </div>
              <div className="grid mt-[0.313rem] lt:grid-cols-2">
                <div className="inline-flex pt-0 items-start h-[1.8rem] pb-[0.05rem] gap-[0.905rem] shrink-0">
                  <div className="h-[1.75rem] flex flex-col justify-center text-[1.2rem] not-italic">
                    <label className="font-semibold leading-[1.8rem] text-[#3f3a64]">Phone:</label>
                  </div>
                  <div className="h-[1.75rem] flex flex-col justify-center text-[1.2rem] not-italic">
                    <span className="font-normal text-[#696969]">+84 972 712 621</span>
                  </div>
                </div>
                <div className="inline-flex pt-0 items-start h-[1.8rem] pb-[0.05rem] gap-[0.905rem] shrink-0">
                  <div className="h-[1.75rem] flex flex-col justify-center text-[1.2rem] not-italic">
                    <label className="font-semibold leading-[1.8rem] text-[#3f3a64]">Location:</label>
                  </div>
                  <div className="h-[1.75rem] flex flex-col justify-center text-[1.2rem] not-italic">
                    <span className="font-normal text-[#696969]">Tp. Ho Chi Minh</span>
                  </div>
                </div>
              </div>
              <div className="grid mt-[0.313rem] lt:grid-cols-2">
                <div className="inline-flex pt-0 items-start h-[1.8rem] pb-[0.05rem] gap-[0.905rem] shrink-0">
                  <div className="h-[1.75rem] flex flex-col justify-center text-[1.2rem] not-italic">
                    <label className="font-semibold leading-[1.8rem] text-[#3f3a64]">Email:</label>
                  </div>
                  <div className="h-[1.75rem] flex flex-col justify-center text-[1.2rem] not-italic">
            ...
            <div className="mt-[2.25rem] flex items-center flex-col gap-[1.13rem] sm:mt-[1.5rem] lt:gap-[3.13rem] lt:mt-[3rem]  lt:flex-row">
             ...
             lt:w-[17.32438rem]"
              >
                <a href="./assets/files/CV_TruongVanChuToan_FrontEnd.pdf" target="_blank" download className="flex justify-center items-center gap-[0.313rem]">
                  <svg width="20" height="18" viewBox="0 0 20 18" fill="none" className="w-[1.20625rem] h-[1.125rem] shrink-0">
                  ...
                  <span className="capitalize text-[1.125rem] text-center text-white not-italic font-bold leading-[1.75rem]">Download My Resume</span>
                </a>
              </button>
              ...
              <div className="flex justify-start items-center w-full h-[2rem] gap-[1.75rem] lt:justify-start lt:order-1 ">
                ...
                <div className="flex items-center gap-[1.6rem]">
                  <a href="#" className="hover:opacity-50 hover:transition-all hover:duration-500 hover:ease-in-out cursor-pointer">
                  ...
                  <a href="https://www.facebook.com/profile.php?id=100068599721013" className="hover:opacity-50 hover:transition-all hover:duration-500 hover:ease-in-out cursor-pointer">
