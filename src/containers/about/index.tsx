							...
							<div className='flex justify-start items-center w-full h-[32px] gap-[28px] lt:justify-start lt:order-1 '>
								...
								<div className='flex items-center gap-[25.5px]'>
									<a
										...
										className='
											group 
										 	hover:cursor-pointer  hover:transition-all hover:duration-500 hover:ease-[cubic-bezier(0.4,0,0.2,1)]
										'>
										<svg
											width={20}
											height={23}
											...
											<g clipPath='url(#clip0_290_102)'>
												<path
													...
													fill='#7d11f9'
													className=' group-hover:fill-[#5d29bb] transition-colors duration-300'
												/>
											</g>
											<defs>
									...
									<a
										href='https://www.facebook.com/profile.php?id=100068599721013'
										className='
											group 
										 	hover:cursor-pointer  hover:transition-all hover:duration-500 hover:ease-[cubic-bezier(0.4,0,0.2,1)]
										'>
