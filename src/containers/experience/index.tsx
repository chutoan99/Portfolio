                    ...
                    <div className="bg-white p-4 rounded-[6px] border border-slate-200 text-slate-500 shadow" data-aos="zoom-in-up">
                      <ul className="flex flex-col items-start gap-[5px] self-stretch">
                        ...
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">
                          <span className="text-description font-bold">HRM: Human resource management.</span> Handle Electronic Medical Records, storing comprehensive medical data for each patient,
                          including medical history, diagnosis, and treatment.
                        </li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">
                          <span className="text-description font-bold">ERP: Enterprise resource planning.</span> Manage all employee information with multiple modules, including personnel, leave,
                          insurance, salary & personal income tax, and labor equipment.
                        </li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">
                          <span className="text-description font-bold">EMR: Electronic medical record.</span> Handle Electronic Medical Records, storing comprehensive medical data for each patient,
                          including medical history, diagnosis, and treatment.
                        </li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6">Team size: 18 and the main tasks:</li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">
                        ...
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">+ Work with the agile scrum methodology.</li>
                      </ul>
                    </div>
                    <div className="bg-white p-4 rounded-[6px] border border-slate-200 text-slate-500 shadow" data-aos="zoom-in-up">
                      <ul className="flex flex-col items-start gap-[5px] self-stretch">
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6">Developed outsource projects:</li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">
                          <span className="text-description font-bold">iOki: Objectives & Key Results.</span> Manage and scor OKR of employees every quarter.
                        </li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6">Team size: 20 and the main tasks:</li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">+ Work with TypeScript, Angular, Jquery, Rxjs, Ngrx, Scss, Bootstrap…</li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">
                          + Ensure precise conversion of Figma designs to web format with pixel-perfect accuracy and responsiveness.
                        </li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">
                          <span className="text-description font-bold">iSecurity: </span>The system consolidates all security features within an area, integrates facial recognition, records, camera
                          management, identification of passenger vehicles upon entry and exit, suggests intrusive behavior, object track on maps…
                        </li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6">Team size: 10 and the main tasks:</li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">+ Work with AngularJs, Javascript, Fabricjs, Bootstrap…</li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">
                        ...
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">
                          <span className="text-description font-bold">iWater: </span>Main features include management water usage history, payment records, employee…
                        </li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6">Team size: 8 and the main tasks:</li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">+ Work with TypeScript, React, Redux, Material UI…</li>
                        <li className="self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]">+ Read and comprehend BA documents to align with project requirements.</li>
                      </ul>
                    </div>
                  </div>
                </div>
