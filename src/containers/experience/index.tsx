    ...
    >
      {EXPERIENCES.map((item: any, index: number) => (
        <div className="rounded-xl bg-white" key={index} data-aos="zoom-in-up">
          <div className="px-[1.563rem] pb-[1.563rem] md:px-[1.75rem] md:pt-[1.75rem] md:pb-[1rem] w-full items-start justify-start flex-col md:flex flex gap-[1rem] md:gap-10 relative lt:flex-row lt:w-[56rem]">
          ...
          <div className="px-[1.563rem] pb-[1.563rem] md:px-[2rem] md:pb-[2rem] w-full lt:w-[56rem] items-start justify-start flex-col md:flex flex gap-[1rem] md:gap-10 relative lt:flex-row ">
