...
export default function Experience() {
	return (
		...
		// 								<div
		// 									className='
		// 										items-center space-x-4 hidden
		// 										md:space-x-2 md:space-x-reverse md:flex
		// 									'>
		// 									<div
		// 										className='
		...
		// 									md:ml-[64px] md:pr-[48px]
		// 								'>
		// 								<div
		// 									className='w-full bg-white p-4 rounded-[6px] border border-slate-200 text-slate-500 shadow'
		// 									data-aos='zoom-in-up'>
		...
		// 											for CIH International
		// 											Hospital and Gia An 155
		// 											Hospital:
		// 										</li>
		...
		// 											modules, including
		// 											personnel, leave, insurance,
		// 											salary & personal income
		// 											tax, and labor equipment.
		// 										</li>
		// 										<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
		// 											<span className='text-description font-bold'>
		...
		// 										</li>
		// 										<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6'>
		// 											Team size: 18 and the main
		// 											tasks:
		// 										</li>
		// 										<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
		// 											+ Work with TypeScript,
		// 											Angular, Rxjs, TailwindCss
		// 											and DevExpress, SQL Server…
		// 										</li>
		// 										<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
		// 											+ Create an API using
		// 											ASP.NET in C#(C Sharp), and
		// 											Document with Swagger for
		// 											the FE.
		// 										</li>
		// 										<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
		// 											+ Collaborate with BA and QC
		// 											to ensure alignment with
		// 											business team objectives and
		// 											requirements.
		// 										</li>
		// 										<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
		...
		// 												Results.
		// 											</span>{' '}
		// 											Manage and scor OKR of
		// 											employees every quarter.
		// 										</li>
		// 										<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6'>
		// 											Team size: 20 and the main
		// 											tasks:
		// 										</li>
		// 										<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
		// 											+ Work with TypeScript,
		// 											Angular, Jquery, Rxjs, Ngrx,
		// 											Scss, Bootstrap…
		// 										</li>
		// 										<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
		// 											+ Ensure precise conversion
		// 											of Figma designs to web
		// 											format with pixel-perfect
		...
		// 											security features within an
		// 											area, integrates facial
		// 											recognition, records, camera
		// 											management, identification
		// 											of passenger vehicles upon
		// 											entry and exit, suggests
		// 											intrusive behavior, object
		// 											track on maps…
		// 										</li>
		// 										<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6'>
		// 											Team size: 10 and the main
		// 											tasks:
		// 										</li>
		// 										<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
		// 											+ Work with AngularJs,
		...
		// 										</li>
		// 										<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
		// 											+ Create Api (accord to
		// 											restful standard) and
		// 											integrate with Fe.
		// 										</li>
		// 									</ul>
		// 								</div>
		...
		<section
			...
			<div className='rounded-xl bg-white flex flex-col justify-center w-full gap-[1rem] md:gap-[1.563rem] lt:w-[60rem] px-[15px] sm:px-[1.563rem] md:px-[1.75rem] pt-[1rem] md:pt-[1.75rem] pb-[1rem] md:pb-[2rem]' data-aos='zoom-in-up'>
				...
				<div className='w-full items-start justify-start flex-col md:flex flex gap-[1rem] md:gap-[40px] relative lt:flex-row'>
					<ul className='flex flex-col items-start gap-1 self-stretch'>
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6'>
							Develop & implement projects for CIH International
							Hospital and Gia An 155 Hospital:
						</li>
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
							<span className='text-description font-bold'>
						...
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
							...
							salary & personal income tax, and labor equipment.
						</li>
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
							<span className='text-description font-bold'>
						...
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
							+ Work with TypeScript, Angular, Rxjs, TailwindCss
							and DevExpress, SQL Server…
						</li>
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
							+ Create an API using ASP.NET in C#(C Sharp), and
							Document with Swagger for the FE.
						</li>
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
						...
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
							+ Create report templates use &quot;report designer
							DevExpress&quot;
						</li>
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
				...
				<div className='w-full items-start justify-start flex-col md:flex flex gap-[1rem] md:gap-[40px] relative lt:flex-row'>
					<ul className='flex flex-col items-start gap-[5px] self-stretch'>
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6'>
							...
							The system consolidates all security features within
							an area, integrates facial recognition, records,
							camera management, identification of passenger
							vehicles upon entry and exit, suggests intrusive
							behavior, object track on maps…
						</li>
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
						...
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
							+ Responsible for maintain, develop new features,
							and manage source code versions of the company
							previously.
						</li>
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
						...
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
							+ Work with TypeScript, Angular, Jquery, Rxjs, Ngrx,
							Scss, Bootstrap…
						</li>
						<li className='self-stretch text-gray-600 text-lg not-italic font-normal leading-6 pl-[10px]'>
							+ Ensure precise conversion of Figma designs to web
							format with pixel-perfect accuracy and
							responsiveness.
						</li>
					</ul>
				</div>
